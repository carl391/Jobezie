...
class ResumeService:
    ...
    def get_resume(resume_id: str, user_id: str) -> Optional[Resume]:
        ...
        return Resume.query.filter_by(id=resume_id, user_id=user_id, is_deleted=False).first()

    @staticmethod
    def get_user_resumes(user_id: str, include_deleted: bool = False) -> List[Resume]:
    ...
    def get_master_resume(user_id: str) -> Optional[Resume]:
        ...
        return Resume.query.filter_by(user_id=user_id, is_master=True, is_deleted=False).first()
