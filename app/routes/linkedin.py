...
def generate_headline():
    ...
    return jsonify({"success": True, "data": headlines}), 200
...
def optimize_experience():
    ...
    return jsonify({"success": True, "data": optimized}), 200
...
def calculate_visibility():
    ...
    return jsonify({"success": True, "data": visibility}), 200
...
def get_industry_keywords(industry: str):
    ...
    """
    keywords = LinkedInService.INDUSTRY_KEYWORDS.get(industry.lower(), [])
