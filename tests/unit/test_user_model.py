...
import pytest
from app.models.user import User, SubscriptionTier, CareerStage
...
class TestUserModel:
    ...
    def test_tier_limits_basic(self, app, db_session):
        ...
        with app.app_context():
            user = User(email='basic@example.com', subscription_tier=SubscriptionTier.BASIC.value)
    ...
    def test_tier_limits_expert(self, app, db_session):
        ...
        with app.app_context():
            user = User(email='expert@example.com', subscription_tier=SubscriptionTier.EXPERT.value)
            limits = user.tier_limits
